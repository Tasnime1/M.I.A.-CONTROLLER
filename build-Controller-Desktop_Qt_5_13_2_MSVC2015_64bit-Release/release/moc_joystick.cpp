...
QT_MOC_LITERAL(3, 15, 9) // "Joystickk"

    },
    "Joystick\0move\0\0Joystickk"
};
...
void Joystick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Joystick::move)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Joystick::move(QString _t1)
{
